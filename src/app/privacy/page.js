        ...
        <div className="relative pb-16 px-4 sm:px-6 lg:px-8">
          <div className="text-lg max-w-5xl mx-auto prose prose-blue md:prose-lg text-gray-500">
            ...
            <p>
              ...
              <Link href="/terms">https://swisscvbuilder.ch/legal</Link>
            </p>
            <h2>
            ...
            <ul>
              <li>
                ...
                propriétaire des données. À chaque fois que des données à
            ...
            <p>
              ...
              SwissCVBuilder sont les suivantes :
            </p>
            <p className="italic">Adresse e-mail.</p>
            <p>
            ...
            <p className="px-6 md:px-10 py-3 italic">
              ...
              commande et effectuer les opérations d'après-vente.
              <br />
            ...
            <p>
              Le site SwissCVBuilder est hébergé par : Vercel Inc., dont le
            ...
            <p>
              ...
              <span className="italic">Irlande</span>.
            </p>
            <h2>
            ...
            <p>
              ...
              : Maxime Lerasle. Il peut être contacté de la manière suivante :
            </p>
            <p className="italic">
              Le responsable des traitements peut être contacté à l'adresse{" "}
              <a href="mailto:contact@swisscvbuilder.ch">
                contact@swisscvbuilder.ch
              </a>
              .
            </p>
            <p>
            ...
            <p>
              ...
              <span className="italic">Maxime Lerasle</span>.
            </p>
            <p>
            ...
            <p>
              ...
              puisse refuser, sauf à démontrer l'existence de motifs légitimes
              et impérieux, pouvant prévaloir sur les intérêts et les droits et
            ...
            <p>
              ...
              est en droit de saisir la PFPDT (Préposé Fédéral à la Protection
            ...
            <p>
              <Link href="/privacy">https://www.swisscvbuilder.ch/privacy</Link>
            </p>
            <p>
